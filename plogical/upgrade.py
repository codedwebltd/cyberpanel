  ...
  CONSTRAINT `websiteFunctions_gdr_owner_id_4cf7983e_fk_websiteFu` FOREIGN KEY (`owner_id`) REFERENCES `websiteFunctions_gdrive` (`id`)
    ...
    'rootdb': {
        ...
        'PORT': '%s',
            ...
            command = 'git clone https://github.com/codedwebltd/cyberpanel.git CyberCP'
            if not Upgrade.executioner(command, command, 1):
    ...
    ### disable dkim signing in rspamd in ref to https://github.com/codedwebltd/cyberpanel/issues/1176
    @staticmethod
    def FixRSPAMDConfig():
...
"""
    ...
    def runSomeImportantBash():
        ...
        # Remove invalid crons from /etc/crontab Reference: https://github.com/codedwebltd/cyberpanel/issues/216
...
'''
    ...
    def upgrade(branch):
        ...
        if not os.path.exists('/usr/local/lsws/bin/openlitespeed'):
            ...
            command = 'wget https://raw.githubusercontent.com/codedwebltd/cyberpanel/main/install/litespeed/httpd_config.xml'
            Upgrade.executioner(command, command, 0)
